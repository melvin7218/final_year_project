...
public class recipe_adapter_mealPlan extends RecyclerView.Adapter<recipe_adapter_mealPlan.RecipeViewHolder> {
    ...
    public recipe_adapter_mealPlan(Context context, List<recipe> recipeList) {
