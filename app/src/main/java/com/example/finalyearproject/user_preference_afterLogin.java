...
public class user_preference_afterLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_preference_after_login);
                ...
                response -> {
                    try {
                        if(response.getBoolean("success")){
                            ...
                            String allergy = data.getString("allergy_ingredients");
                            int age = data.getInt("age");
                            int height = data.getInt("height");
                            int weight = data.getInt("weight");
                            tvSelectedCuisineType.setText(data.getString("cuisine_type"));
                            tvSelectedAllergy.setText(allergy);
